...
let AMapPlugin = AMapPlugin_1 = class AMapPlugin extends core_1.IonicNativePlugin {
    ...
    onGeofenceResult() {
        return new rxjs_1.Observable((observer) => {
            // @ts-ignore
            window.AMapPlugin.onGeofenceResult(observer.next.bind(observer), observer.next.bind(observer));
        });
    }
    ;
    removeGeofence(params) {
        return (0, core_1.cordova)(this, "removeGeofence", {}, arguments);
    }
    ;
    clearGeofence() {
        return (0, core_1.cordova)(this, "clearGeofence", {}, arguments);
    }
    ;
};
